...
wget https://github.com/Rhyuu11/zivpn/releases/download/udp/udp-zivpn-linux-amd64 -O /usr/local/bin/zivpn 1> /dev/null 2> /dev/null
chmod +x /usr/local/bin/zivpn
mkdir /etc/zivpn 1> /dev/null 2> /dev/null
wget https://raw.githubusercontent.com/Rhyuu11/zivpn/main/config.json -O /etc/zivpn/config.json 1> /dev/null 2> /dev/null
